...
namespace PayRoleSystem
{
    class Program
    {
        ...
        {
            //SalariedEmployee salariedEmployee = new SalariedEmployee{FirstName = "James",LastName = "Stuart", EmployeeID = 754, WeeklySalary = 6000m};
            ...
            Console.WriteLine("=== POLYMORPHYCALLY ACCESSING METHODS OF OBJECTS CREATED FROM GENERIC COLLECTION CLASS");
            ...
            payments.Add(commissionedEmployee);
